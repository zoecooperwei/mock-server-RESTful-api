...
app.post('/api/movies', function (req, res) {
    ...
    var newM = new Movie(movies.length + 1, req.body.name, req.body.year, req.body.director, req.body.rating, req.body.desp);
...
exports.Movie = Movie;
var movies = [
    new Movie(1, "The Shawshank Redemption", 1994, 'Frank A. Darabont', 9.6, 'Fear Can Hold You Prisoner, Hope Can Set You Free'),
    new Movie(2, "Farewell My Concubine", 1993, 'Chen Kaige', 9.6, 'This is not simply a movie, it`s the LIFE'),
    new Movie(3, "Leon", 1994, 'Luc Besson', 9.4, 'Shape of my heart'),
    new Movie(4, "Forrest Gump", 1994, 'Robert Zemeckis', 9.4, 'Mama always said life was like a box of chocolates. You never know what you`re gonna get'),
    new Movie(5, "La vita è bella", 1997, 'Roberto Benigni', 9.5, 'Buongiorno, la mia principessa'),
    new Movie(6, "Titanic", 1997, 'James Cameron', 9.3, 'He saved me,in every way that a person can be saved'),
    ...
    new Movie(15, "A Chinese Odyssey Part Two - Cinderella", 1995, 'Jeffrey Lau', 9.2, '一生所爱'),
    new Movie(16, "The Truman Show", 1998, 'Peter Weir', 9.2, 'Good morning, and in case I don`t see ya, good afternoon, good evening, and good night!'),
    new Movie(17, "The Godfather", 1972, 'Francis Ford Coppola', 9.2, 'Because a man who doesn`t spend time with his family can never be a real man'),
    new Movie(18, "My Neighbor Totoro", 1988, 'Hayao Miyazaki', 9.1, 'Path of wind'),
    new Movie(19, "Interstellar", 2014, 'Christopher Nolan', 9.2, 'Do not go gentle into that good night'),
    new Movie(20, "Silenced", 2011, 'Dong-hyuk Hwang', 9.2, 'We can not change the world, but we can be not changed by the world')
];
app.listen(3001);
